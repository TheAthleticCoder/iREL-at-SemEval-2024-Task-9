...
# template
template = """
You are given a question and several choices below. Please tell me which option number you think is correct:
Question: {}
Choices:\n{}
"""
...
for entry in tqdm(data, desc="Formatting Entries", unit="entry"):
    ...
    #formatting the choices with options and newline characters
    formatted_choices = '\n'.join([f"Option {i}: {choice}" for i, choice in enumerate(choices, start=1)])
    #formatting the entry using the template
